...
;; IRONVAULT - BITCOIN-SECURED CREDIT PROTOCOL

;; Built on Stacks | Powered by Bitcoin's Security
;;
;; IronVault transforms idle Bitcoin into productive capital through trustless
;; overcollateralized lending. Lock BTC, access instant liquidity, maintain
;; Bitcoin exposure-all secured by Bitcoin's proof-of-work consensus.
...
(define-private (is-valid-price (price uint))
    (and 
        (> price u0)
        (<= price u1000000000000) ;; Upper bound for price sanity check
    )
)
        ...
        (begin
            ...
            (map-set loans
                {loan-id: loan-id}
                {
                    ...
                    interest-rate: u5, ;; 5% annual interest
